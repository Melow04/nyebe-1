...
export default function Home() {
  return (
     ...
     <div className="flex flex-col relative w-screen h-screen">
      ...
      <div className="self-end w-screen h-screen m-auto absolute z-[-1] object-cover flex mt-10">
      <Image src={'/hero/hero.jpg'} alt="" width={500} height={300} quality={100} className="object-cover w-[50%]" />
        <Image src={'/hero/white.jpg'} alt="" width={700} height={700} quality={100} className="object-cover w-[50%]" />
      </div>
<Header />
<div>
      {/* Container */}
      <div className="mx-20 mt-20 w-full max-w-8xl py-16 text-white ">
        {/* Component */}
